...
riot.mount('foo');
riot.mount('route');
},{"./tags/base/foo.tag":2,"./tags/base/login.tag":3,"./tags/base/route.tag":4,"./tags/base/tag1.tag":5,"./tags/base/tag2.tag":6,"riot":7}],2:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('foo', '<a href="#tag1">tag1</a> <a href="#tag2">tag2</a> <bar></bar>', '', '', function(opts) {
...
var riot = require('riot');
module.exports = riot.tag2('login', '<form onsubmit="{login}"> <input name="username" type="text" placeholder="username"> <input name="password" type="password" placeholder="password"> <button>Submit</button> </form>', '', '', function(opts) {
...
var riot = require('riot');
module.exports = riot.tag2('route', '', '', '', function(opts) {
  this.on('mount', function() {
...
var riot = require('riot');
module.exports = riot.tag2('tag1', '<h3>tag1</h3>', '', '', function(opts) {
});
},{"riot":7}],6:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('tag2', '<h3>tag2</h3>', '', '', function(opts) {
});
